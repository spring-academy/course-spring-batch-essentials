...
The input file in `src/main/resources/billing-2026-01.csv` has the following format:
...
Here is a sample from the input file, which you can also check by opening the `src/main/resources/billing-2026-01.csv` file in the **Editor**:

```editor:open-file
file: ~/exercises/src/main/resources/billing-2026-01.csv
description: "Open billing-2026-01.csv"
```

| Year | Month | Account Number | Phone Number | Data Usage | Call Duration | SMS Count |
| ---- | ----- | -------------- | ------------ | ---------- | ------------- | --------- |
| 2026 | 1     | 100            | 404-555-1234 | 12.5       | 0             | 3         |
| 2026 | 1     | 101            | 404-555-5678 | 7.8        | 5             | 1         |
| 2026 | 1     | 102            | 404-555-9101 | 45.2       | 2             | 0         |
| 2026 | 1     | 104            | 404-555-2345 | 22.1       | 0             | 1         |
| 2026 | 1     | 105            | 404-555-6789 | 8.9        | 10            | 0         |
| 2026 | 1     | 106            | 404-555-1112 | 3.2        | 3             | 2         |
| 2026 | 1     | 107            | 404-555-1314 | 17.6       | 0             | 4         |
| 2026 | 1     | 108            | 404-555-1516 | 28.9       | 7             | 1         |
| 2026 | 1     | 109            | 404-555-1718 | 11.3       | 2             | 3         |
