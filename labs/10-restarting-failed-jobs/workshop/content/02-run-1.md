`input/billing-2026-03.csv` contains the billing data for March 2026. This file contains 500 lines of billing data, similar to previous files.
...
1. Run the job.
   ...
   Next, launch the `BillingJob` with the following parameters to process `billing-2026-03.csv`:
...
1. Analyze the failure.
   ...
   ```shell
   org.springframework.batch.infrastructure.item.file.FlatFileParseException: Parsing error at line: 226 in resource=[file [/home/eduk8s/exercises/input/billing-2026-03.csv]], input=[2026,03,325,404-555-1225,92-94,375,544]
   ...
   ...
   Open `input/billing-2026-03.csv` and inspect line 226:
   ...
   ```csv
   2026,03,325,404-555-1225,92-94,375,544
   ```
